...
public class RSAEncrypt {
    ...
    private static final ConcurrentHashMap<Integer, String> keyMap = new ConcurrentHashMap<>();  //用于封装随机产生的公钥与私钥
     ...
     * @param publicKey 公钥
     * @return 密文
     * @exception Exception 加密过程中的异常信息
     */
     ...
     * @param privateKey 私钥
     * @return 铭文
     * @exception Exception 解密过程中的异常信息
     */
